...
%changelog
* Wed Mar 30 2022 Jingwiw <ixoote@gmail.com> - 1.3.3-1
- init from openSUSE
  author: openSUSE
  url: https://build.opensuse.org/package/view_file/openSUSE:Factory:RISCV/libdvbpsi/libdvbpsi.spec
  changes: https://build.opensuse.org/package/view_file/openSUSE:Factory:RISCV/libdvbpsi/libdvbpsi.changes